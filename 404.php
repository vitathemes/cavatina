...
<aside class="o-page__col c-aside">
    <div class="c-aside__content">
        <div class="c-aside__context">
            <span class="c-aside__title">404 Page</span>
        </div>
...
<main class="o-page__main o-page--404">
    <section class="error-404 not-found">
        <header class="page-header">
            <h1 class="not-found__error">404</h1>
            <h2 class="page-title"><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'wp-cavatina' ); ?></h2>
        </header><!-- .page-header -->
