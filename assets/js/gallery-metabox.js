jQuery(function ($) {
  ...
  $(document).on("click", "#gallery-metabox a.gallery-add", function (e) {
    ...
    file_frame.on("select", function () {
      var listIndex = $("#gallery-metabox-list li").index(
          $("#gallery-metabox-list li:last")
        ),
      ...
      selection.map(function (attachment, i) {
        ...
        $("#gallery-metabox-list").append(
          '<li><input type="hidden" name="vdw_gallery_id[' +
            index +
            ']" value="' +
            attachment.id +
