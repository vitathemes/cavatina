	...
	*/
	function cavatina_get_social_media() {
		...
		if ( get_theme_mod('linkedin_link') != null) { 
			...
			echo '      
			<a href="'. get_theme_mod('linkedin_link') .'" class="c-social-media__item">
		...
		if ( get_theme_mod('facebook_link') != null) { 
			...
			echo '      
			<a href="'. get_theme_mod('facebook_link') .'" class="c-social-media__item">
		...
		if ( get_theme_mod('github_link') != null) { 
			...
			echo '      
			<a href="'. get_theme_mod('github_link') .'" class="c-social-media__item">
		...
		if ( get_theme_mod('twitter_link') != null) { 
			...
			echo '      
			<a href="'. get_theme_mod('twitter_link') .'" class="c-social-media__item">
